...
public abstract class SearchPageObject extends MainPageObject {
    ...
    public void skipFirstPage() {
        this.waitForElementAndClick(SKIP_FIRST_PAGE, "Cannot find SKIP element", 1);
    ...
    public void waitForElementByTitleAndDescription(String title, String description) {
        ...
        this.waitForElementPresent(search_result_element_with_article_description, "Cannot find element with " + title + " or " + description);
    }

    public void initSearchInput() {
        this.waitForElementAndClick(SEARCH_INIT_ELEMENT, "Cannot find and click search init element", 5);
        this.waitForElementPresent(SEARCH_INIT_ELEMENT, "Cannot find and click search init element", 5);
    }
